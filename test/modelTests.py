...
class SingleOccurrenceEntryTests(unittest.TestCase):
    ...
    def test_event_beyond_end_time(self):
        time = datetime(2015, 05, 23, 22, 0, 0, tzinfo=TZ)
        end_date = datetime(2006, 01, 01, tzinfo=TZ)
    ...
    def test_event_before_current_time(self):
        time = datetime(1980, 05, 23, 22, 0, 0, tzinfo=TZ)
        end_date = datetime(2006, 05, 26, tzinfo=TZ)
    ...
    def test_time_equal_to_start_time(self):
        time = datetime(2006, 8, 1, 8, 42, 0, tzinfo=TZ)
...
class RecurringEntryTests(unittest.TestCase):
    ...
    def test_query_end_date_before_start_date(self):
        ...
        start_date = datetime(2006, 06, 04, tzinfo=TZ)
        end_date = datetime(2006, 06, 03, tzinfo=TZ)
    ...
    def test_query_end_date_before_entries_start_date(self):
        ...
        start_date = datetime(2006, 02, 04, tzinfo=TZ)
        end_date = datetime(2006, 02, 05, tzinfo=TZ)
    ...
    def test_daily_recurring_entry(self):
        ...
        start_date = datetime(2006, 06, 04, tzinfo=TZ)
        end_date = datetime(2006, 06, 10, tzinfo=TZ)
    ...
    def test_monthly_multi_day_over_query_date(self):
        self.__multi_day_tester(datetime(2006, 10, 26, tzinfo=TZ), 1)

    def test_monthly_multi_day_start_of_query_date(self):
        self.__multi_day_tester(datetime(2006, 10, 25, tzinfo=TZ), 1)

    def test_monthly_multi_day_end_of_query_date(self):
        self.__multi_day_tester(datetime(2006, 10, 27, tzinfo=TZ), 1)

    def test_monthly_multi_day_misses_query_date(self):
        self.__multi_day_tester(datetime(2006, 10, 24, tzinfo=TZ), 0)

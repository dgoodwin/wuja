#!/usr/bin/env python
#
# Fetch the Google Feed for the Wuja Testing Calendar, and save it to sampledata.py so the
# unit tests can import it easily.
#
# Run from the test directory only, otherwise your sampledata.py will be in the wrong place.
